    ...
    return (
        <Accordion type="single" collapsible>
            <AccordionItem value="item-1">
                <AccordionTrigger className={"hover:underline-offset-4"} >Детальніше</AccordionTrigger>
                <AccordionContent>
                    <ul >
            ...
            <AccordionItem value="item-2">
                <AccordionTrigger className={"hover:underline-offset-4"}>Опис</AccordionTrigger>
                <AccordionContent>
            ...
            <AccordionItem value="item-3">
                <AccordionTrigger className={"hover:underline-offset-4"}>Найважливіше</AccordionTrigger>
                <AccordionContent>
